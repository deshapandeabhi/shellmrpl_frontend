...
function RouteTracker() {
  ...
  useEffect(() => {
    ...
    const routes = {
      ...
      '/board-of-directors': { title: 'Board of Directors', desc: 'The leadership guiding Shell MRPL Aviation.' },
    ...
    const current = routes[pathname] || { title: 'Aviation Services', desc: 'Shell MRPL Aviation' };

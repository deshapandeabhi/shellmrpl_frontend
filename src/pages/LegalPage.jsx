      ...
      <div className="content-wrap" style={{ padding: '80px 0' }}>
        <div className="content-narrow">
          ...
          <div className="legal-body" style={{ padding: '40px', borderRadius: '24px', border: '1px solid rgba(var(--shell-white-rgb),0.15)', background: 'var(--night-600)', color: 'rgba(var(--shell-white-rgb),0.85)', lineHeight: '1.8' }}>
            ...
            <h4 style={{ color: 'var(--shell-white)', marginBottom: '16px', fontWeight: 800 }}>1. General Statement</h4>
            <p style={{ marginBottom: '24px' }}>
            ...
            <h4 style={{ color: 'var(--shell-white)', marginBottom: '16px', fontWeight: 800 }}>2. Compliance & Standards</h4>
            <p>

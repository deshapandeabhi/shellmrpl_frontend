          ...
          <div className="legal-body" style={{ padding: '40px', borderRadius: '24px', border: '1px solid rgba(var(--shell-white-rgb),0.15)', background: 'var(--night-600)', color: 'rgba(var(--shell-white-rgb),0.85)', lineHeight: '1.8' }}>
            {title === 'Privacy Policy' ? (
              <>
                ...
                <h4 style={{ color: 'var(--shell-white)', marginBottom: '16px', fontWeight: 900 }}>2. Data Usage and Security</h4>
                <p style={{ marginBottom: '24px' }}>
                ...
                <h4 style={{ color: 'var(--shell-white)', marginBottom: '16px', fontWeight: 900 }}>3. Cookies and Tracking</h4>
                <p>
              ...
              <>
                ...
                <h4 style={{ color: 'var(--shell-white)', marginBottom: '16px', fontWeight: 900 }}>3. Governing Law</h4>
                <p>
